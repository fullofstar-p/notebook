...
* xxxxxxxxxx23 1public class Test1 {2    public static void main(String[] args) {3        // 创建TreeMap集合对象4        TreeMap<Student,String> tm = new TreeMap<>();5      6        // 创建学生对象7        Student s1 = new Student("xiaohei",23);8        Student s2 = new Student("dapang",22);9        Student s3 = new Student("xiaomei",22);10      11        // 将学生对象添加到TreeMap集合中12        tm.put(s1,"江苏");13        tm.put(s2,"北京");14        tm.put(s3,"天津");15      16        // 遍历TreeMap集合,打印每个学生的信息17        tm.forEach(18                (Student key, String value)->{19                    System.out.println(key + "---" + value);20                }21        );22    }23}java
